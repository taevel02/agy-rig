...
Activate when the user's message starts with "Implement the following plan", "계획대로 실행", "계획에 따라", "실행", "진행 가능", "직접 수정" followed by a plan body, or links to a `/think` output.
